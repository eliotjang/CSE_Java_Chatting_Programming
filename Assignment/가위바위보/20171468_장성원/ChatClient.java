...
public class ChatClient extends Frame implements ActionListener
{
   ...
   public ChatClient(String str){
      ...
      cc_btgame = new Button("게임방입장");
      cc_btgame.addActionListener(this);
      bt_panel.add(cc_btgame);
   ...
   public void actionPerformed(ActionEvent ae){
      ...
      }else if(ae.getSource().equals(cc_btgame)) {
    	  msg_logon = cc_tfLogon.getText(); 
          if(!msg_logon.equals("")){
             cc_thread.requestgame(msg_logon); 
          }else{
             MessageBox msgBox = new MessageBox(this, "로그온", "logon first..");
             msgBox.show();
          }
