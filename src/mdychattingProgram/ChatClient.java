...
public class ChatClient extends Frame implements ActionListener
{
   ...
   public ChatClient(String str){
      ...
      cc_tfStatus = new TextField("ID를 먼저 입력해야합니다",43); 
      ...
      centerpanel.add(new Label("Your logon time is "));
      cc_tfDate = new TextField("...",31);
      ...
      southpanel.add(new Label("Logon Users List"));
