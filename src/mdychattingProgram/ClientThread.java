...
public class ClientThread extends Thread
{
 ...
 //broad cast case
   ...
   /* �뜝�룞�삕�뜝�룞�삕�샇�뜝�룞�삕�듃�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕
          �뜝�룞�삕�뜝�룞�삕 : java ChatClient �샇�뜝�룞�삕�듃�뜝�떛紐뚯삕 �뜝�룞�삕�듃�뜝�룞�삕�샇 
   	  To DO .....				*/

   // �뜝�룞�삕�뜝�룞�삕�샇�뜝�룞�삕�듃�뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕閭먨뜝占� �뜝�룞�삕�뜝�떦�슱�삕 �뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕
   // �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕 �겢�뜝�룞�삕�뜝�떛�뼲�삕�듃�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕 �뜝�떆�룞�삕�뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕髥��뜝占�. 
   public ClientThread(ChatClient client) {
      try{
         ...
         thisThread = this;
         ct_client = client; // �뜝�룞�삕泥닷뜝�룞�삕�뜝�룞�삕�뜝�룞�삕 �뜝���뙋�삕
      }catch(IOException e){
         ...
         while(currThread == thisThread){ //exit in LOG_OFF by thisThread=null;
            ...
            switch(command){
               ...
               case MDY_USERIDS:{
                  ...
                  String ids = st.nextToken(); //chatting user list...�듃
               ...
               // �뜝�룞�삕�뜝�룞�삕 �뜝�뙣�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝占�  PACKET : YES_SENDWORDS|ID|�뜝�룞�삕�솕�뜝�룞�삕
               case YES_SENDWORDS:{
                  String id = st.nextToken(); // �뜝�룞�삕�솕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�룞�삕�뜝�룞�삕 ID�뜝�룞�삕 �뜝�룞�삕�뜝�떬�뙋�삕.
                  try{
            ...
            Thread.sleep(200);
         } // while �뜝�룞�삕�뜝�룞�삕(�뜝�룞�삕�뜝�룞�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕)
   ...
   // �뜝�룞�삕�듃�뜝�룞�삕�겕 �뜝�뙓�슱�삕�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�떬�뙋�삕.
   public void release(){ };
   ...
   // Logon �뜝�룞�삕�궥(REQ_LOGON|ID)�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�떦怨ㅼ삕 �뜝�룞�삕�뜝�룞�삕�뜝�떬�뙋�삕.
   public void requestLogon(String id) {
      try{
         logonbox = new MessageBox(ct_client, "logon", "wait for connect to server.");
         logonbox.show();
         ct_buffer.setLength(0);   // Logon �뜝�룞�삕�궥�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�떬�뙋�삕.
         ct_buffer.append(REQ_LOGON);
         ct_buffer.append(SEPARATOR);
         ct_buffer.append(id);
         send(ct_buffer.toString());   // Logon �뜝�룞�삕�궥�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�떬�뙋�삕.
      }catch(IOException e){
         System.out.println(e);
      }
   }
   ...
   public void requestSendWords(String words) {
      try{
         ct_buffer.setLength(0);   // SendWords �뜝�룞�삕�궥�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�떬�뙋�삕.
         ct_buffer.append(REQ_SENDWORDS);
         ct_buffer.append(SEPARATOR);
         ct_buffer.append(ct_client.msg_logon);
         ct_buffer.append(SEPARATOR);
         ct_buffer.append(words);
         send(ct_buffer.toString());   // SendWords �뜝�룞�삕�궥�뜝�룞�삕 �뜝�룞�삕�뜝�룞�삕�뜝�떬�뙋�삕.
      }catch(IOException e){
         System.out.println(e);
      }
   }
